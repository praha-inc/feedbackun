  ...
  '@media': {
    '(prefers-color-scheme: dark)': {
      vars: {
        ...
        [theme.color.token.semantic.backgroundMuted]: theme.color.palette.gray800,
        ...
        [theme.color.token.badge.text]: theme.color.palette.gray300,
        [theme.color.token.badge.border]: theme.color.palette.gray500,
        [theme.color.token.badge.background]: theme.color.palette.gray800,
        [theme.color.token.badge.hover.text]: theme.color.palette.gray300,
        [theme.color.token.badge.hover.border]: theme.color.palette.gray200,
        [theme.color.token.badge.hover.background]: theme.color.palette.gray700,
        ...
        [theme.color.token.tabs.active.background]: theme.color.palette.gray900,

        [theme.color.token.tooltip.text]: theme.color.palette.white,
        [theme.color.token.tooltip.background]: theme.color.palette.gray500,
      },
    },
  },
});
